        ...
        navbar.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (itemId == R.id.setting) {
                    ...
                    startActivity(new Intent(SettingActivity.this, StatisticalChartActivity.class));
                    overridePendingTransition(0, 0);
                    return true;
                } else if (itemId == R.id.card) {
                    loadingDialog.startLoadingDialog();
                    loadingDialog.setDialogDuration(2000);
                    startActivity(new Intent(SettingActivity.this, CardIntroductionActivity.class));
                    overridePendingTransition(0, 0);
                    return true;
