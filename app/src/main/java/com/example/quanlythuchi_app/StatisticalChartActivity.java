        ...
        navbar.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    ...
                    if (itemId == R.id.report) {
                        ...
                        startActivity(new Intent(StatisticalChartActivity.this, HomeActivity.class));
                        overridePendingTransition(0, 0);
                        return true;
                    } else if (itemId == R.id.card) {
                        loadingDialog.startLoadingDialog();
                        loadingDialog.setDialogDuration(2000);
                        startActivity(new Intent(StatisticalChartActivity.this, CardIntroductionActivity.class));
                        overridePendingTransition(0, 0);
                        return true;
                    } else if (itemId == R.id.setting) {
                        loadingDialog.startLoadingDialog();
                        loadingDialog.setDialogDuration(2000);
                        startActivity(new Intent(StatisticalChartActivity.this, SettingActivity.class));
                        overridePendingTransition(0, 0);
                        return true;
                    }
                return false;
